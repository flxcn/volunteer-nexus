        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    WHERE engagements.volunteer_id = '{$_SESSION['volunteer_id']}' AND opportunities.end_date >= CURDATE()
                    GROUP BY opportunities.start_date, opportunities.end_date, opportunities.start_time, opportunities.end_time, engagements.engagement_id, events.event_name, opportunities.opportunity_name, opportunities.opportunity_id";
