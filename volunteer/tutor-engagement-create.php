...
$tutorEngagementFormPopulatorObj = new TutorEngagementFormPopulator($sponsor_id);

// Populate volunteer array for "volunteer name" dropdown boxes, and initialize JSON object
$jsonSponsors = $engagementFormPopulatorObj->getSponsors();
...
<body onload='loadSponsors(); loadEvents();'>
    <div class="wrapper">
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <div class="form-group <?php echo (!empty($volunteer_name_error)) ? 'has-error' : ''; ?>">
                            ...
                            <p><?php echo $_SESSION["volunteer_name"];?></p>
