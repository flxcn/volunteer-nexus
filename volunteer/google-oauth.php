...
if (isset($_GET['code'])) {
  ...
  echo "<div class='col s12 m6 offset-m3 center-align'>
    <a class='oauth-container btn darken-4 white black-text' href='".$client->createAuthUrl() ."' style='text-transform:none'>
      <div class='left'>
