        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarsExample03">
                <ul class="navbar-nav me-auto mb-2 mb-sm-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if ($thisPage === 'Volunteers') {echo 'active';} ?>" href="volunteers.php">Volunteers</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php if ($thisPage === 'Sponsors') {echo 'active';} ?>" href="sponsors.php">Sponsors</a>
                    </li>
                </ul>
