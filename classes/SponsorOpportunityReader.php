...
class SponsorOpportunityReader
{
	...
	public function __construct($sponsor_id, $event_id)
    {
    ...
    public function getEngagements(int $opportunity_id) {
        $sql = 
            "SELECT engagements.time_submitted AS time_submitted, 
                    engagements.opportunity_id AS opportunity_id, 
            ...
            WHERE   engagements.opportunity_id = :opportunity_id
            GROUP   BY engagements.time_submitted, 
